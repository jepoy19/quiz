...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Kat-on </b></a>
        </div>
    ...
    <div class="row">
        <div class="col">
            <img src="image/1.gif" alt="kat-on" id="home-img" class="img-fluid mx-auto d-block" style="margin-left: auto; margin-right:auto; width:1200px; height: 400px; margin-top:-40px;">
        </div>
    </div>
</div>
